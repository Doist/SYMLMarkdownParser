...
@optional
@property (readonly) NSDictionary *headingAttributes, *horizontalRuleAttributes, *blockquoteAttributes, *listElementAttributes, *listLineAttributes, *emphasisAttributes, *strongAttributes, *inlineCodeAttributes, *linkAttributes, *linkTitleAttributes, *linkTagAttributes, *invalidLinkAttributes, *urlAttributes, *todoistReferenceAttributes;
